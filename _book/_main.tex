...
The US Chemical Advisor to the ARVN's Chemical Team participated in planning the operation, and suggested using a Mity Mite (a.k.a. Mitey Mite, Mighty Mite) fogger to aid in clearing tunnels.
...
\caption{Federal Laboratories 298 \citep{Applegate1992}}\label{fig:fedlabimg}
\end{figure}
