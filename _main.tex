...
\listoffigures
\begin{center}\includegraphics[width=500px]{img/cover} \end{center}
...
\caption{M-106 Mighty Mite Thermal Fogger, as promoted to law enforcement in \citet{Applegate1969}.}\label{fig:imgM106}
\end{figure}
...
The General Ordnance Equipment Corporation (GOEC), who had just trademarked Chemical Mace the year prior, began marketing a hand-held thermal fogger using the phrase ``Pepper Fog'' in July 1968, a nod to the ability of the fogger to ``pepper'' the recipient with more concentrated bursts of fog if desired \citep{Applegate1969}.
They applied for a trademark on the phrase in October of the same year \citep{USTPO2018}.
By the end of August 1969, GOEC and its corporate owners Smith and Wesson had received the trademark on ``Pepper Fog'', which they (and subsequent owners) retained until it expired in 1991 \citep{USTPO2018}.
...
\caption{GOEC advertisment \citep{GOECad1969}.}\label{fig:imggoecad1969}
\end{figure}
